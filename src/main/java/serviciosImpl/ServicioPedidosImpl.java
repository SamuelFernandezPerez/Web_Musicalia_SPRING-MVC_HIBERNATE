...
public class ServicioPedidosImpl implements ServicioPedidos{
	...
	@Override
	public void procesarPaso1(String nombreCompleto, String direccion, String provincia, String telefono, String cp, Usuario usuario) {
	...
	public void procesarPaso3(String textArea, Usuario usuario) {
		Pedido p = obtenerPedidoActual(usuario);
		p.setObservaciones(textArea);	
		sessionFactory.getCurrentSession().update(p);
	}
