...
<br>
<springform:form modelAttribute="usuario" action="guardarNuevoUsuario" enctype="multipart/form-data">
...
<input class="mt-10 mb-10 inline-flex items-center px-4 py-2 text-2xl  font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-[#134e4a] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-[#0f766e] dark:hover:bg-[#134e4a] dark:focus:[#134e4a]" type="submit" value="REGISTRAR USUARIO"/>
</div>
</springform:form>
</body>
</html>
